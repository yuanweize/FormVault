...
def upgrade() -> None:
    ...
    op.create_table('applications',
        ...
        sa.Column('insurance_type', sa.Enum('health', 'auto', 'life', 'travel', name='insurance_type_enum'), nullable=False),
        sa.Column('preferred_language', sa.String(5), nullable=False, server_default='en'),
        sa.Column('status', sa.Enum('draft', 'submitted', 'exported', 'processed', name='application_status_enum'), nullable=False, server_default='draft'),
        sa.Column('created_at', sa.DateTime(), nullable=False, server_default=sa.text('CURRENT_TIMESTAMP')),
        sa.Column('updated_at', sa.DateTime(), nullable=False, server_default=sa.text('CURRENT_TIMESTAMP')),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_reference_number', 'applications', ['reference_number'], unique=True)
    ...
    op.create_table('files',
        ...
        sa.Column('file_type', sa.Enum('student_id', 'passport', name='file_type_enum'), nullable=False),
    ...
    op.create_index('idx_files_application_id', 'files', ['application_id'], unique=False)
    ...
    op.create_table('email_exports',
        sa.Column('id', sa.String(36), nullable=False),
        sa.Column('application_id', sa.String(36), nullable=False),
        sa.Column('recipient_email', sa.String(255), nullable=False),
        sa.Column('insurance_company', sa.String(255), nullable=True),
        sa.Column('status', sa.Enum('pending', 'sent', 'failed', 'retry', name='export_status_enum'), nullable=False, server_default='pending'),
    ...
    op.create_index('idx_exports_application_id', 'email_exports', ['application_id'], unique=False)
    op.create_index('idx_exports_status', 'email_exports', ['status'], unique=False)
    op.create_index('idx_exports_created_at', 'email_exports', ['created_at'], unique=False)
    op.create_index('idx_recipient_email', 'email_exports', ['recipient_email'], unique=False)
    ...
    op.create_index('idx_audit_application_id', 'audit_logs', ['application_id'], unique=False)
