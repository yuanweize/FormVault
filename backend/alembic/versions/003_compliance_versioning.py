...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_evidence_records_evidence_type", "evidence_records", ["evidence_type"]
    )
    op.create_index("ix_evidence_records_sha256", "evidence_records", ["sha256"])
    op.create_index(
        "ix_evidence_records_verification_status",
        "evidence_records",
        ["verification_status"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "company_id",
            sa.Integer(),
            sa.ForeignKey("insurance_companies.id", ondelete="CASCADE"),
            nullable=False,
        ),
        ...
        sa.Column("valid_until", sa.DateTime(), nullable=True),
        sa.Column(
            "status", sa.String(length=30), server_default="HISTORICAL", nullable=False
        ),
        sa.Column(
            "evidence_id",
            sa.String(length=36),
        ...
        sa.Column(
            "currency", sa.String(length=10), server_default="CZK", nullable=False
        ),
    ...
    op.create_index(
        "ix_product_versions_product_code", "product_versions", ["product_code"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "price_book_id",
            sa.Integer(),
            sa.ForeignKey("price_books.id", ondelete="CASCADE"),
            nullable=False,
        ),
        ...
        sa.Column(
            "extra_months_free", sa.Integer(), server_default="0", nullable=False
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
    )
    op.create_index(
        "ix_price_rates_duration_months", "price_rates", ["duration_months"]
    )
    ...
    op.create_index(
        "ix_legal_document_versions_doc_type", "legal_document_versions", ["doc_type"]
    )
    op.create_index(
        "ix_legal_document_versions_status", "legal_document_versions", ["status"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "intermediary_disclosure_version_id",
            sa.Integer(),
            sa.ForeignKey("legal_document_versions.id", ondelete="RESTRICT"),
            nullable=True,
        ),
    ...
    op.create_index(
        "ix_disclosure_bundle_snapshots_bundle_hash",
        "disclosure_bundle_snapshots",
        ["bundle_hash"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "consent_given", sa.Boolean(), server_default=sa.text("1"), nullable=False
        ),
    ...
    op.create_index(
        "ix_partner_handoff_consents_application_id",
        "partner_handoff_consents",
        ["application_id"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "severity", sa.String(length=20), server_default="LOW", nullable=False
        ),
        sa.Column(
