...
class FileService:
    ...
    async def upload_file(
        ...
        try:
            ...
            # Store file securely
            stored_filename, file_hash, file_size = await self.storage.store_file(file, file_id)
            ...
            raise DatabaseException(f"Failed to save file metadata: {str(e)}", "file_upload")
    ...
    def verify_file_integrity(self, db: Session, file_id: str) -> bool:
        ...
        return self.storage.verify_file_integrity(db_file.stored_filename, expected_hash)
