...
class TestApplicationCreation:
    ...
    def test_create_application_success(self, client, db_session, sample_application_data):
    ...
    def test_create_application_with_files(self, client, db_session, sample_application_data, sample_file):
    ...
    def test_create_application_invalid_file_reference(self, client, db_session, sample_application_data):
    ...
    def test_create_application_duplicate_email_handling(self, client, db_session, sample_application_data):
    ...
    @patch('app.utils.database.create_audit_log')
    def test_create_application_audit_log_failure(self, mock_audit_log, client, db_session, sample_application_data):
    ...
    def test_create_application_request_headers_logging(self, client, db_session, sample_application_data):
    ...
    def test_create_application_phone_validation(self, client, db_session, sample_application_data):
        ...
        for phone in valid_phones:
            ...
            sample_application_data["personal_info"]["email"] = f"test{phone or 'none'}@example.com"
        ...
        for phone in invalid_phones:
            sample_application_data["personal_info"]["phone"] = phone
            sample_application_data["personal_info"]["email"] = f"invalid{phone}@example.com"
            
            response = client.post("/api/v1/applications/", json=sample_application_data)
            assert response.status_code == 422
    
    def test_create_application_age_validation(self, client, db_session, sample_application_data):
...
class TestApplicationCreationErrorHandling:
    ...
    def test_database_error_handling(self, mock_application, client, sample_application_data):
