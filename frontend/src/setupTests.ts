  ...
  useTranslation: () => ({
    t: (key: string, options?: Record<string, any>) => {
      const translations: Record<string, string> = {
        ...
        'forms.personalInfo.subtitle': 'Enter your personal details',
        'forms.personalInfo.sections.personal': 'Personal Details',
        'forms.personalInfo.sections.address': 'Address Details',
        ...
        'forms.fileUpload.studentId.description': 'Upload a clear photo or scan of your student ID card',
        'forms.fileUpload.passport.label': 'Passport',
        'forms.fileUpload.passport.description': 'Upload a clear photo or scan of your passport',
        ...
        'pages.review.title': 'Review Your Application',
        'pages.review.subtitle': 'Please review your information before submitting',
        'pages.review.incompleteWarning': 'Please complete all steps before proceeding',
        'pages.review.missingPersonalInfo': 'Missing personal information',
        'pages.review.missingFiles': 'Missing required documents',
        'pages.review.sections.personalInfo': 'Personal Information',
        'pages.review.sections.uploadedFiles': 'Uploaded Documents',
        'pages.review.fileNotUploaded': 'No file uploaded',
        'pages.review.readyToProceed': 'All set! You can now proceed to submission.',
        'pages.review.proceedToConfirmation': 'Proceed to Confirmation',
        'pages.confirmation.title': 'Confirm Submission',
        'pages.confirmation.subtitle': 'Please review and confirm your details.',
        'pages.confirmation.incompleteWarning': 'Your application is incomplete.',
        'pages.confirmation.missingPersonalInfo': 'Missing personal information.',
        'pages.confirmation.missingFiles': 'Missing required files.',
        'pages.confirmation.sections.personalInfo': 'Personal Information',
        'pages.confirmation.sections.uploadedFiles': 'Uploaded Documents',
