...
// Default Czech Republic fallback broker data (universal & non-blocking)
const DEFAULT_CZECH_COMPANIES: InsuranceCompanyShowcase[] = [
  {
    ...
    description: 'Fully recognized by the Czech Ministry of Interior (OAMP) for foreigners residency permits.',
    display_order: 1,
  },
  {
    id: 2,
    ...
    description: 'High limit comprehensive medical insurance with rapid claim settlements across Czechia.',
    display_order: 2,
  },
  {
    id: 3,
    ...
    description: 'Specialized health and accident insurance for foreign students and professionals.',
    display_order: 3,
  },
  {
    id: 4,
    ...
    code: 'UNIQA',
    rating: 'European Group / AAA Rated',
    website: 'https://www.uniqa.cz',
    description: 'Comprehensive health and travel liability coverage compliant with EU standards.',
    display_order: 4,
  },
];
...
const DEFAULT_CZECH_PLANS: InsurancePlanShowcase[] = [
  {
    ...
    currency: 'CZK',
    billing_period: 'year',
    coverage_summary: 'Up to 10,000,000 CZK medical coverage compliant with Czech Foreigners Act 326/1999 Coll.',
    badge: 'Most Popular',
    target_audience: 'Foreign Students & Long-Term Visa Holders',
    features: 'Czech OAMP compliant\nDirect hospital billing\n24/7 multilingual assistance\nRepatriation included',
    is_featured: true,
    display_order: 1,
  },
  {
    ...
    currency: 'CZK',
    billing_period: 'year',
    coverage_summary: 'Tailored for university students in Prague, Brno & across Czechia with full outpatient care.',
    badge: 'Best Student Rate',
    target_audience: 'University Students (Under 26)',
    features: 'Act 326/1999 Coll. certified\nPreventive vaccines included\nQuick digital claims\nAccident rider option',
    is_featured: true,
    display_order: 2,
  },
  {
    ...
    currency: 'CZK',
    billing_period: 'year',
    coverage_summary: 'Comprehensive medical security for employees, trade license holders (Živnostenský list) & families.',
    badge: 'Full Protection',
    target_audience: 'Professionals & Families',
    features: 'Maternity & hospitalization\nEmergency dental coverage\nWorldwide EU/Schengen rider\nNo health questionnaire',
    is_featured: true,
    display_order: 3,
  },
  {
    ...
    badge: 'Instant Certificate',
    target_audience: 'Short-term Visitors & Schengen Visas',
    features: 'Instant PDF certificate\nEmergency EU medical care\nMedical repatriation\nZero deductible',
    is_featured: false,
    display_order: 4,
  },
];
